...
function Alta() {
    ...
    let pais:string = String($("#txtPais").val());
    let provincia:string = String($("#txtProvincia").val());
    ...
    let empleado: proyecto.Empleado = new proyecto.Empleado(nombre, apellido, dni, fNacimiento, sexo, direccion, telefono, estadoCivil, foto, legajo, cuil, ingreso, pais,provincia);
...
function Modificar(legajo: number) {
    ...
    let pais:string = String($("#mdPais").val());
    let provincia:string = String($("#mdProvincia").val());
...
function TraerPaises(){
    let data:any[] = Data();
    let paises = data.map(function(pais){
        return pais["pais"];
    })
    return paises;
}

function TraerProvincias(pais:string){
    let data:any[] = Data();
    let prov = data.filter(function(provincia){
        return provincia["pais"] == pais;
    });
    let provincias = prov.map(function(provincia){
...
function SelectProvincias(){
    let pais = String($("#txtPais").val());
    let provincias:any[] = TraerProvincias(pais);
    let html= "";
...
function Data():any[]{
    let data = [{"pais":"Czech Republic","provincia":"Petrov"},
